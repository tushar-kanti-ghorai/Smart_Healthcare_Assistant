...
def process_image(image_path, query):
    try:
        ...
        llama_16e_response = make_api_request("meta-llama/llama-4-scout-17b-16e-instruct")
        llama_128e_response = make_api_request("meta-llama/llama-4-maverick-17b-128e-instruct")

        responses = {}
        for model, response in [("llama11b", llama_16e_response), ("llama90b", llama_128e_response)]:
